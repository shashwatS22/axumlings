...
//
// Hint: FromRef extracts a subset of state. Implement it to return AppState.db for handlers that need DbState.
...
// TODO: impl FromRef<AppState> for DbState
...
async fn handler(/* TODO: State<DbState> */) -> String {
    // TODO: Return format!("conn: {}", db.conn)
    "conn: ???".to_string()
}
