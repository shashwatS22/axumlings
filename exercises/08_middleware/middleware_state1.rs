...
async fn check_key(
    ...
    // TODO: Get request.headers().get("x-api-key")
    // TODO: If header != s.api_key, return StatusCode::UNAUTHORIZED.into_response()
...
fn app() -> Router {
    ...
    Router::new()
        ...
        // TODO: .route_layer(middleware::from_fn_with_state(state.clone(), check_key))
        .with_state(state)
}
